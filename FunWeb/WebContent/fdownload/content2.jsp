...
<td colspan="3">
<%-- <a href="../upload/<%=bb.getFile()%>"><%=bb.getFile() %></a> 첨부파일 링크 --%>
<%-- <img src="../upload/<%=bb.getFile()%>" width="100" height="100"></td></tr> 이미지를 화면에 보여줌--%>
<a href="file_down2.jsp?file_name=<%=bb.getFile()%>">다운로드 : <%=bb.getFile()%></a>
...
onclick="location.href='fupdateForm.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>'">
<input type="button" value="글삭제" class="btn"
onclick="location.href='fdeleteForm.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>'">
	<%
	}
}
%>
...
onclick="location.href='notice2.jsp?pageNum=<%=pageNum%>'">
</div>
<div class="clear"></div>
<div id="page_control">
</div>
